...
public class Customer implements Serializable,Cloneable {
    ...
    public Customer(String custName, String custIndustry, String custAddress, String custPhone) {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.IDENTITY/*, generator = "pk_gen"*/) //主键生成
    @Column(name="cust_id" )
    /*@TableGenerator(name = "pk_gen",
            table="tb_generator",
            pkColumnName="generator_name",
            valueColumnName="generate_value",
            pkColumnValue="nextValue",
            allocationSize = 1,
            initialValue = 1314
    )*/
    private Long custId;
